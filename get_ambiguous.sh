...
do
    ...
    echo 'url: ' ${authors[$a]}
    python crawler.py --author=$a --author-page=${authors[$a]} --depth=3 --output=data/dblp_$a.pckl --log
    # python crawler.py --author=$a --author-page=${authors[$a]} --depth=3 --output=data/dblp_$a.pckl
    echo ''; echo '';
done
